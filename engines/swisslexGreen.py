...
class SwisslexGreen(Adapter):
    ...
    def request(self, suchwort, filters="", start=0, count=Adapter.LISTSIZE):
        ...
        body = {
            "paging": {"CurrentPage": page, "HitsPerPage": count},
            "searchFilter": {
                "searchText": suchwort,
                "navigation": "",
                "searchLanguage": 1,
                ...
                "thesaurusInformation": "",
                "nSelected": 0,
                "journalCriteria": [],
                "caseCollectionCriteria": [],
                "bookCriteria": [],
                "paging": {"CurrentPage": 1, "HitsPerPage": 25},
        ...
        response = requests.post(
            url=self.host + self.suchpfad, data=json.dumps(body), headers=self.headers
        )
